function scaleinvpts = fracharrislaplace(img)
    sig0 = 1.5;
    scaleFactor = 1.2;
    s = 0.7;
    ...
    imageScaleSpace = [];
    interestPoints = {};
    %% Creating the scale space and subsequent detection of interest points at the scale 
    for n = 1:7
...
%         g = fspecial('gaussian',[5 5],sigi);
        ...
        threshold = 5e2;
        scaledInterestPoints = FracHarrisInterestPoints(img,sigi,sigd,threshold);
